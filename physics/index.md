...
AI and machine learning applications in physics — from simulation acceleration to discovering physical laws.
...
<div class="hub-topics">
  ...
  <a class="hub-topic-tile" href="/physics/symbolic-regression">
    ...
    <span class="hub-topic-desc">Discovering equations and physical laws from data</span>
  </a>
  <a class="hub-topic-tile" href="/physics/quantum">
    <span class="hub-topic-name">Quantum Systems</span>
    <span class="hub-topic-desc">ML for quantum computing and quantum physics</span>
  </a>
</div>
